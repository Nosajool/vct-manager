...

  {
    ...
    options: [
      ...
      },
      {
        ...
        personalityWeights: { STABLE: 2, INTROVERT: 1, BIG_STAGE: 1 },
      },
      {
        tone: 'AGGRESSIVE',
        ...
        personalityWeights: { FAME_SEEKER: 2, BIG_STAGE: 2, STABLE: 0 },
      },
    ],
  },

  {
    ...
    options: [
      ...
      },
      {
        ...
        personalityWeights: { BIG_STAGE: 2, FAME_SEEKER: 1, INTROVERT: 1 },
      },
    ],
  },
    ...
    options: [
      {
        ...
        personalityWeights: { BIG_STAGE: 2, FAME_SEEKER: 1 },
      },
      {
        tone: 'HUMBLE',
