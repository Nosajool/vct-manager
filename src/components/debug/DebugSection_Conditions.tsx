...
const CATEGORY_COLORS: Record<DramaCategory, string> = {
  ...
  cove_incident: 'bg-cyan-900/40 text-cyan-300',
  ...
  scrim_sharing: 'bg-teal-900/40 text-teal-300',
  org_culture: 'bg-yellow-900/40 text-yellow-300',
  ...
  coaching_beef: 'bg-orange-900/40 text-orange-300',
  free_agent_pursuit: 'bg-cyan-900/40 text-cyan-300',
  player_conflict: 'bg-purple-900/40 text-purple-300',
};
