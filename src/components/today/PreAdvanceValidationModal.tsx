        ...
        <div className="p-4 space-y-3">
          ...
          <div className="bg-vct-dark/50 rounded-lg p-3 border border-vct-gray/20">
            <p className="text-xs text-vct-gray">
              <strong className="text-vct-light">Auto-Configure:</strong> Activities
              will be set up automatically at 80% efficiency. You can review and
              customize them first if you prefer.
            </p>
          </div>
        </div>
