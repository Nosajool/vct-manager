...
export function TimeBar() {
  ...
  const handleTimeAdvance = async (advanceFn: (withProgress: boolean) => Promise<TimeAdvanceResult>) => {
    ...
    try {
      ...
      if (patchAfterAdvance && patchBeforeAdvance?.id !== patchAfterAdvance.id) {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 md:gap-4">
              <div className="flex items-center gap-2">
                <span className="hidden md:inline text-vct-gray text-sm">Date:</span>
              ...
              {hasMatchToday && (
                <>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="hidden md:inline text-vct-light text-sm">vs {opponentName}</span>
                  </div>
                </>
              )}
            </div>
