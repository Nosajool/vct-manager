        ...
        <div className="p-6 space-y-6">
          ...
          <div className="bg-vct-dark/50 border border-vct-gray/20 rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-sm font-semibold text-vct-light">Composition</h3>
                <p className="text-xs text-vct-gray">Role distribution</p>
              </div>
              <div
    ...
    <div className="text-center">
      ...
      <div className="flex items-center justify-center gap-2">
        <button
          onClick={onDecrement}
          disabled={count <= 0}
          className="w-7 h-7 bg-vct-gray/20 hover:bg-vct-gray/30 disabled:opacity-30 disabled:cursor-not-allowed text-vct-light rounded transition-colors text-sm"
        >
          -
        </button>
        <span className="text-lg font-bold text-vct-light w-5">{count}</span>
        <button
          onClick={onIncrement}
          disabled={count >= 3}
          className="w-7 h-7 bg-vct-gray/20 hover:bg-vct-gray/30 disabled:opacity-30 disabled:cursor-not-allowed text-vct-light rounded transition-colors text-sm"
